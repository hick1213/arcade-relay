...
探讨方案:
- **A. 按功能划分的知识文档 + 引用注入（最小变更、无需变更 contract）**: 在 `.codex/docs/unity-craft/` 放置按功能划分的指南（timeline.md / animator.md / vfx.md / ui-motion.md / cinemachine.md / shader.md），从 tech-stack-unity.md 引用。在 ui-engineer / gameplay-engineer 的「参考文档」中添加相应指南，在 polish story 的 acceptance 中要求「至少应用1项相应指南的技法」。
