...
export const ZH_TABLE: Readonly<Record<string, string>> = {
  ...
  // 成长阶段別台词の伙计別库（S-28: gdd「伙计初始值」差分表 — 各伙计の性格ごとに 3 段）
  [TEXT_KEYS.STAFF_LINE_AFU_1]: '盘子又滑手了…我再练练',
  [TEXT_KEYS.STAFF_LINE_AFU_2]: '上菜稳当多了，客官请！',
  [TEXT_KEYS.STAFF_LINE_AFU_3]: '残影都追不上我，江湖第一小二！',
  [TEXT_KEYS.STAFF_LINE_TIENIU_1]: '烟又糊了锅底…唉',
  [TEXT_KEYS.STAFF_LINE_TIENIU_2]: '火候稳了，菜香得很',
  [TEXT_KEYS.STAFF_LINE_TIENIU_3]: '金光出菜，包客官满意！',
  [TEXT_KEYS.STAFF_LINE_WENQU_1]: '一文钱要数三遍…别催',
  [TEXT_KEYS.STAFF_LINE_WENQU_2]: '算盘拨得飞快，账目清楚',
  [TEXT_KEYS.STAFF_LINE_WENQU_3]: '分毫不差，掌柜的尽管放心',
  [TEXT_KEYS.STAFF_LINE_XIAODIE_1]: '同手同脚…别笑我',
  [TEXT_KEYS.STAFF_LINE_XIAODIE_2]: '脚步轻快了许多',
  [TEXT_KEYS.STAFF_LINE_XIAODIE_3]: '穿梭如燕，桌面锃亮！',
  [TEXT_KEYS.STAFF_LINE_DASONG_1]: '我只会挡…',
  [TEXT_KEYS.STAFF_LINE_DASONG_2]: '守门的事，交给我',
  [TEXT_KEYS.STAFF_LINE_DASONG_3]: '有我在，谁也别想闯进来！',
  // 志向选择（S-04: 财/侠/名）
